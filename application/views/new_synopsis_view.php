			...
			<div class="innerLR innerT">
				<div class="widget">
					<div class="widget-head">
						<h3 class="heading">New Synopsis for <?php echo $project_id ?></h3>
					</div>
					<div class="widget-body">
						<div class="row-fluid">
							<form action="/project/new_synopsis/<?php echo $project_id?>" method="post">
								<label>Objective</label>
								<input type="text" name="objective" class="span12"><br /><br />
								<input type="submit" value="Begin" class="btn btn-icon btn-primary">
							</form>
						</div>
					</div>
				</div>
