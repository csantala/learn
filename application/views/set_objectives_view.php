...
<!--[if !IE]><!--><html><!-- <![endif]-->
<head>
	<title><?php echo $project_id?> new synopses</title>
			...
			<div class="innerLR innerT">
				<div class="widget">
					<div class="widget-head">
						<h3 class="heading">Set Objectives for <?php echo $project_id ?></h3>
					</div>
					<div class="widget-body">
						<div class="row-fluid">
							<form action="/project/set_objectives/<?php echo $project_id?>" method="post">
								<table class="ExcelTable2007">
									<tr>
										<th></th>
										<th>Objective</th>
									</tr>
								<?php for ($i = $current_objective_id; $i < $current_objective_id + 6; $i++) { ?>
								<tr>
									<td class="objective_count">
										<?php echo $i?>
									</td>
									<td>
										<input class="task" type="text" name="<?php echo $i?>" class="span12">
									</td>
								</tr>
								<?php } ?>
								</table>
								<br />
								<input type="submit" value="      Set      " class="btn btn-icon btn-primary">
							</form>
						</div>
					</div>
				</div>
