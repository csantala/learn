				...
				<div class="widget">
					...
					<div class="widget-body">
						<div class="row-fluid">
							...
							<?php
								foreach ($all_users as $all_user) { //ds($all_user);
							?>
									<tr>
										<td><?php echo $all_user->user_id?></td>
										<td><?php echo $all_user->user_level?></td>
										<td><?php // echo date("F j, Y g:i:a", $all_user->user_date)?></td>
										<td><?php echo $all_user->user_name?></td>
										<td><?php echo $all_user->user_timezone?></td>
										<td>edit</td>
									</tr>
							<?php } ?>
							</table>
