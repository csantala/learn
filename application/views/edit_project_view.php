			...
			<div class="innerLR innerT">
				<div class="widget">
					<div class="widget-head">
						...
						<a href="/synopses/project/<?php echo $project->project_id?>" class="details pull-right">return</a>
					</div>
					<div class="widget-body">
						<div class="row-fluid">
							<form action="/project/edit_project/<?php echo $project->project_id?>" method="post">
								<label>Project Name</label>
								<input class="span12" type="text" name="title" value="<?php echo $project->title?>">
								<label>Project Description</label>
								<input class="span12" type="text" name="description" value="<?php echo $project->description?>">
								<label>GitHub</label>
								<input class="span12" type="text" name="github_link" value="<?php echo $project->github_link?>">
								<label>Local</label>
								<input class="span12" type="text" name="local_link" value="<?php echo $project->local_link?>">
								<label>Staging</label>
								<input class="span12" type="text" name="staging_link" value="<?php echo $project->staging_link?>">
								<label>Production</label>
								<input class="span12" type="text" name="production_link" value="<?php echo $project->production_link?>">
